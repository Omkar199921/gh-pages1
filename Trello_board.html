...
<html>
	<head>
		...
		<link href="fontawesome-free/css/all_min.css" rel="stylesheet">
	...
	<body>
		...
		<div class="board-container">
            		<div class="board-menu">
                		<div class="board-title">Frontend Training
                		</div>
            		...
            		<div class="board">
                		<div class="task-list-wrapper">
                    			<div class="task-list">
                        			...
                        			<div class="add-card-message pointer">+ Add another card
                        			</div>
                    			</div>
                		</div>
                		<div class="task-list-wrapper">
                    			<div class="task-list">
                        			...
                        			<div class="task pointer">Prepare resume
                        			</div>
                		...
                		<div class="task-list-wrapper">
                    			<div class="task-list">
                        			...
                        			<div class="task pointer">Twitter app frontend
                        			</div>
                        			<div class="add-card-message pointer">+ Add another card
                        			</div>
                    			</div>
                		...
                		<div class="task-list-wrapper">
                    			<div class="task-list">
                        			...
                        			<div class="task pointer">Twitter app backend
                        			</div>
                        			<div class="add-card-message pointer">+ Add another card
                        			</div>
                    			</div>
                		...
                		<div class="task-list-wrapper">
                    			<div class="task-list">
                        			...
                        			<div class="add-card-message pointer">+ Add card
                        			</div>
                    			</div>
                		</div>
                		<div class="task-list-wrapper">
                    			<div class="task-list">
                        			<div class="add-list-message pointer">+ Add another list
                        			</div>
                    			</div>
                		</div>
                		<div class="task-list-wrapper">
